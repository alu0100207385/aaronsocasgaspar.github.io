langEs = {
  ...
  "coverLetter" : "Estimado Sr/Sra:"
                  ...
                  +"Actualmente estoy trabajando para Atos dentro del departamento de I+D+i, investigando y desarrollando módulos relacionados con la seguridad y privacidad."
                  +"Mi experiencia profesional como desarrollador la he realizado en la empresa INTEGRA Tecnología y Comunicación de Canarias, SL. También poseo conocimientos en administración de sistemas, tengo el título de formación profesional 2º grado de Diplomado Técnico Superior en Sistemas y estuve como becario en la Cámara de Comercio de Santa Cruz de Tenerife y en la Universidad de La Laguna. He orientado mi formación hacia la tecnología web, desarrollo en la nube, gestión de contenidos y seguridad."
                  +"Soy una persona activa, curiosa. responsable, constante y perfeccionista, con una gran capacidad de trabajo y esfuerzo. Soy capaz de adaptarme a las distintas situaciones y a los cambios, pudiendo trabajar de forma efectiva en equipo o individual."
                  +"Un cordial saludo,"
                  +"Aarón Socas Gaspar"
};
